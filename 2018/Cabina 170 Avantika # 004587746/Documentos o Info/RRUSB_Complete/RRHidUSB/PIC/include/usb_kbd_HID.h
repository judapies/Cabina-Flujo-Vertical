...
//////////////////////////////////////////////////////////////////
   ...
   //endpoint descriptor 1 IN
         ...
         18  //polling interval, in ms.  (cant be smaller than 10 for slow speed devices)     ==33
   ...
   //endpoint descriptor 1 OUT
         ...
         18  //polling interval, in ms.  (cant be smaller than 10 for slow speed devices)     ==40
   };
...
//////////////////////////////////////////////////////////////////
   ...
   const char USB_DEVICE_DESC[] = {
      //starts of with device configuration. only one possible
         ...
         0x68,0x4E, //product id   ==11,12  //don't use ffff says usb-by-example guy.  oops
...
char const USB_STRING_DESC[]={
   //string 0
         ...
         0xA1,0x01,   //Microsoft Defined for US-English
   //string 1
