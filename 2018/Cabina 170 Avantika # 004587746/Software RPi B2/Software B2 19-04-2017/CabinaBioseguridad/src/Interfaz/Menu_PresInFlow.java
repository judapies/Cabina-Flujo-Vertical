 ...
 */
public class Menu_PresInFlow extends javax.swing.JFrame {

    /**
     * Creates new form Menu_TiempoPurga
     */
    public Menu_PresInFlow() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Presión InFlow");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_PresInFlow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_PresInFlow().setVisible(true);
            }
        });
    }
