 ...
 */
public class Menu_TempoUV extends javax.swing.JFrame {
    ...
    public Menu_TempoUV() {
        ...
        LabelMinutos.setText(String.format("%02d",Variables.UVMinutos));
        LabelSegundos.setText(String.format("%02d",Variables.UVSegundos));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Temporizador Luz UV");
        ...
        jLabel7.setText("La tecla Menú para almacenar el valor.");

        jLabel6.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        jLabel6.setText("Utilice las teclas Arriba y Abajo para aumentar o disminuir.");

        jLabel8.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        jLabel8.setText("La tecla OK para cambiar de horas a minutos o viceversa.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_TempoUV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_TempoUV().setVisible(true);
                System.out.println("Minutos: "+Variables.UVMinutos);
            }
        });
    }
